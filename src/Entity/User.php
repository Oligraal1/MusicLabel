...
class User implements UserInterface
{
     ...
     */
    public function getStreamings(): ArrayCollection
    {
     ...
     */
    public function getActualites(): ArrayCollection
    {
